...
def Generator():
    ...
    # classifier
    last = Conv3DTranspose(2, kernel_size=ks, strides=2, padding='same', kernel_initializer='he_normal', activation='softmax', name='output_generator')(x)
...
def Discriminator():
    ...
    Discriminator model
    '''
    inputs = Input((128,128,128,2), name='input_image')
